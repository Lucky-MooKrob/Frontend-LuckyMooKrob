  ...
  products: InsuranceProduct[] = [
    ...
    },
    {
      ...
      insuranceMiniDetailsName:
        'First class  Chronic respiratory insurance 1 0-30',
      insuranceMiniDetailsPic:
        'https://image.bangkokbiznews.com/image/kt/media/image/news/2020/09/10/897354/750x422_897354_1599783351.jpg?x-image-process=style/LG',
      insuranceMiniDetailsPrice: 30000,
      insuranceMiniDetailsFBulletin:
    ...
    },
    {
      ...
      insuranceMiniDetailsName:
        'First class  Chronic respiratory insurance 2 31-40',
      insuranceMiniDetailsPic:
        'https://image.bangkokbiznews.com/image/kt/media/image/news/2020/09/10/897354/750x422_897354_1599783351.jpg?x-image-process=style/LG',
      insuranceMiniDetailsPrice: 40000,
      insuranceMiniDetailsFBulletin:
    ...
    },
    {
      ...
      insuranceMiniDetailsName:
        'First class  Chronic respiratory insurance 3 41-50',
      insuranceMiniDetailsPic:
        'https://image.bangkokbiznews.com/image/kt/media/image/news/2020/09/10/897354/750x422_897354_1599783351.jpg?x-image-process=style/LG',
      insuranceMiniDetailsPrice: 50000,
      insuranceMiniDetailsFBulletin:
    ...
    },
    {
      ...
      insuranceMiniDetailsName:
        'First class  Chronic respiratory insurance 51-70',
      insuranceMiniDetailsPic:
        'https://image.bangkokbiznews.com/image/kt/media/image/news/2020/09/10/897354/750x422_897354_1599783351.jpg?x-image-process=style/LG',
      insuranceMiniDetailsPrice: 60000,
      insuranceMiniDetailsFBulletin:
    ...
    },
    {
      ...
      insuranceMiniDetailsName:
        'First class  Diabetes mellitus insurance 1 0-30',
      insuranceMiniDetailsPic:
        'https://image.bangkokbiznews.com/image/kt/media/image/news/2020/09/10/897354/750x422_897354_1599783351.jpg?x-image-process=style/LG',
      insuranceMiniDetailsPrice: 30000,
      insuranceMiniDetailsFBulletin:
    ...
    },
    {
      ...
      insuranceMiniDetailsName:
        'First class  Diabetes mellitus insurance 2 31-40',
      insuranceMiniDetailsPic:
        'https://image.bangkokbiznews.com/image/kt/media/image/news/2020/09/10/897354/750x422_897354_1599783351.jpg?x-image-process=style/LG',
      insuranceMiniDetailsPrice: 40000,
      insuranceMiniDetailsFBulletin:
    ...
    },
    {
      ...
      insuranceMiniDetailsName:
        'First class  Diabetes mellitus insurance 3 41-50',
      insuranceMiniDetailsPic:
        'https://image.bangkokbiznews.com/image/kt/media/image/news/2020/09/10/897354/750x422_897354_1599783351.jpg?x-image-process=style/LG',
      insuranceMiniDetailsPrice: 50000,
      insuranceMiniDetailsFBulletin:
    ...
    },
    {
      ...
      insuranceMiniDetailsName:
        'First class  Diabetes mellitus insurance 51-70',
      insuranceMiniDetailsPic:
        'https://image.bangkokbiznews.com/image/kt/media/image/news/2020/09/10/897354/750x422_897354_1599783351.jpg?x-image-process=style/LG',
      insuranceMiniDetailsPrice: 60000,
      insuranceMiniDetailsFBulletin:
    ...
    if (this._listOfDiseaseSelected.length != 0) {
      ...
      for (let i = 0; i < this._listOfDiseaseSelected.length; i++) {
        let data = this.filteredProduct.filter(
          (p) =>
            p.insuranceMiniDetailsDisease.toLowerCase().replace(/ +/g, '') ==
            this._listOfDiseaseSelected[i].toLowerCase().replace(/ +/g, '')
        );
        if (data != undefined) {
          temp = [...temp, ...data];
        }
  ...
  onCheckedProduct(eventData: {
    ...
    if (eventData.selected) {
      ...
      this.selectedProducts = this.selectedProducts.filter(
        (product) =>
          product.insuranceMiniDetailsID !==
